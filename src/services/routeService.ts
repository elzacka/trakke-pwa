...
class RouteService {
  ...
  async getAllWaypoints(): Promise<Waypoint[]> {
    ...
    return new Promise((resolve, reject) => {
      ...
      request.onerror = () => {
        reject(new Error(`Failed to get waypoints: ${request.error?.message || 'Unknown error'}`))
      }
    })
  }
  ...
  async getAllRoutes(): Promise<Route[]> {
    ...
    return new Promise((resolve, reject) => {
      ...
      request.onerror = () => {
        reject(new Error(`Failed to get routes: ${request.error?.message || 'Unknown error'}`))
      }
    })
  }
  ...
  async getAllProjects(): Promise<Project[]> {
    ...
    return new Promise((resolve, reject) => {
      ...
      request.onerror = () => {
        reject(new Error(`Failed to get projects: ${request.error?.message || 'Unknown error'}`))
      }
    })
  }
