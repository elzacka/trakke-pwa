        ...
        return [
          {
            ...
            attrs: {
              ...
              'content': "default-src 'self'; script-src 'self'; style-src 'self' 'unsafe-inline'; img-src 'self' data: https://cache.kartverket.no; font-src 'self'; connect-src 'self' https://cache.kartverket.no https://ws.geonorge.no; worker-src 'self'; frame-src 'none'; object-src 'none'; base-uri 'self';"
            },
            injectTo: 'head'
          }
        ]
